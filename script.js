        ...
        .then(data => {
            if (data.error || data.message) {
                ...
                detailsContent.innerHTML = `
                    ...
                    <div class="detail-item"><strong>Lantai:</strong> <span title="${data.lantai}">${data.lantai}</span></div>
                    <div class="detail-item"><strong>Ruang Teori:</strong> <span title="${data.ruang_teori}">${data.ruang_teori}</span></div>
                    <div class="detail-item"><strong>Ruang Lab:</strong> <span title="${data.ruang_lab}">${data.ruang_lab}</span></div>
                    <div class="detail-item"><strong>Ruang Rapat:</strong> <span title="${data.ruang_rapat}">${data.ruang_rapat}</span></div>
                    <div class="detail-item"><strong>Ruang Sholat:</strong> <span title="${data.ruang_sholat}">${data.ruang_sholat}</span></div>
                    <div class="detail-item"><strong>Toilet:</strong> <span title="${data.toilet}">${data.toilet}</span></div>
                    <div class="detail-item"><strong>Jumlah Ruangan:</strong> <span title="${data.jumlah_ruangan}">${data.jumlah_ruangan}</span></div>
                    <div class="detail-item"><strong>Akses Wifi:</strong> <span title="${data.akses_wifi}">${data.akses_wifi}</span></div>
                    <div class="detail-item"><strong>Jam Operasional:</strong> <span title="${data.jam_operasional_a} - ${data.jam_operasional_b}">${data.jam_operasional_a} - ${data.jam_operasional_b}</span></div>
                `;
